...
namespace Paon.NNetwork
{
	public class GamingHubClient : IGamingHubReceiver
	{
        ...
        public Task FlagAsync(int Mode, DateTime nowTime)
        {
            return client.FlagAsync(Mode, nowTime);
        }
		...
		void IGamingHubReceiver.OnMove(Player player)
		{
			...
			if (players.TryGetValue(player.Name, out var doll))
			{
				...
				doll
						...
						.GetChild(1)
						.SetPositionAndRotation(player.LeftPosition,
						player.Rotation * Quaternion.Euler(0f, 180f, -90f));
				doll
						.transform
						.GetChild(2)
						.SetPositionAndRotation(player.RightPosition,
