...
namespace Paon.NUI
{
  public class MainMenuScript : MonoBehaviour
  {
    ...
    private void SetStatistics()
    {
      ...
      //       "回";
      string a = "横断歩道がない車道に入った回数: " + PlayerPrefs.GetInt("Taboo_Road", 0) + "回";
      string b = "横入りした回数: " + PlayerPrefs.GetInt("Taboo_Intrusion", 0) + "回";
      GameObject.Find("Content").GetComponent<Text>().text = a + "\n" + b + "\n";
    }
