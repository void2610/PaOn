	...
	public class RightHandMove : MonoBehaviour
	{
		...
		async void FixedUpdate()
		{
			...
			if (canMove)
			{
				...
				if (isCalib)
					hand.transform.localPosition = new Vector3(coords.x / 100 - 2, -coords.y / 100 + 2, hand.transform.localPosition.z);
				else
					hand.transform.localPosition = new Vector3(-coords.x / 50 + 2, -coords.y / 100 + 1, hand.transform.localPosition.z);
			}
		}
	}
}
