...
public class Visualizer : MonoBehaviour
{
	...
	void LateUpdate()
	{
		...
		holisticPipeline
				.ProcessImage(webCamInput.inputImageTexture, holisticInferenceType);
	}
	...
	void OnRenderObject()
	{
		...
		if (
				holisticInferenceType == HolisticInferenceType.full ||
	...
	void PoseRender()
	{
		...
		Graphics
				...
				6,
				holisticPipeline.poseVertexCount);
	}
	...
	void HandRender(bool isRight)
	{
		...
		handMaterial
				.SetBuffer("_vertices",
				isRight
						? holisticPipeline.rightHandVertexBuffer
						: holisticPipeline.leftHandVertexBuffer);
		...
		Graphics
				.DrawProceduralNow(MeshTopology.Triangles,
				96,
				holisticPipeline.handVertexCount);
